...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        LadderGame game = new LadderGame(participants, new Ladder(participants.size(), ladderHeight), new StandardOutDisplayLadder());
        game.displayLadder();
    }

    public static List<String> inputParticipants(Scanner scan) {
        System.out.println("참여할 사람 이름을 입력하세요. (이름은 쉼표(,)로 구분하세요");
        List<String> participants = Arrays.asList(scan.nextLine().split(","));
