...
class LadderLineTest {
    ...
    public void makeLineAndCheckHeight() {
        ...
        Assertions.assertThat(line.getLadderJointsContainer().size()).isEqualTo(5);
    }

    @Test
    public void makeLineAndCheckJointChain() {
        LadderLine line = new LadderLine(3, "");
        LadderJoint joint0 = line.getLadderJointsContainer().get(0);
        LadderJoint joint1 = line.getLadderJointsContainer().get(1);
        LadderJoint joint2 = line.getLadderJointsContainer().get(2);
