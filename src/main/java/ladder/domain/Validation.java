...
class Validation {
    ...
    static void validateLadderResults(ArrayList<String> ladderResults, int namesSize) {
    ...
    static void validateLadderResult(String ladderResult) {
    ...
    static void validateNames(ArrayList<String> names) {
        condition(!names.isEmpty(), new InvalidName(ErrorMessage.EMPTY_NAMES.getMessage()));
        names.forEach(name -> validateName(name, null));
    }

    static void validateName(String name, HashMap<String, String> playerResults) {
