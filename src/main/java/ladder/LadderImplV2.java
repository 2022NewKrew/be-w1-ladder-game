...
public class LadderImplV2 implements Ladder{
    private int width;
    private int height;
    ...
    public static class RandomLadderBuilder implements LadderBuilder {
        ...
        public Ladder createLadder(LadderInputInfo ladderInfo) throws IllegalArgumentException {
            ...
            return new LadderImplV2(ladderInfo, buildLadder());
        }
    ...
    private LadderImplV2(LadderInputInfo ladderInputInfo, List<LadderFloor> ladder) {
