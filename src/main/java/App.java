...
import game.frontendapi.usertoapp.UserInputPlayersNames;

public class App {
    public static void main(String[] args) {
        // 실행할 게임을 선택, 유저와의 인터페이스 객체를 생성하여 주입
        Game game = new LadderGame(new UserInputPlayersNames(), new UserInputInteger(), new UserScreenOutputConsole());
